...
#define CYBLE_CAPSENSE_SENSORS_CHAR_INDEX   (0x00u) /* Index of Sensors characteristic */
#define CYBLE_CAPSENSE_SENSORS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENSE_SENSORS_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */
#define CYBLE_CAPSENSE_CONTROL_CHAR_INDEX   (0x01u) /* Index of Control characteristic */
#define CYBLE_CAPSENSE_STATUS_CHAR_INDEX   (0x02u) /* Index of Status characteristic */
#define CYBLE_CAPSENSE_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_CAPSENSE_SERVICE_HANDLE   (0x000Cu) /* Handle of CapSense service */
#define CYBLE_CAPSENSE_SENSORS_CHAR_HANDLE   (0x000Eu) /* Handle of Sensors characteristic */
#define CYBLE_CAPSENSE_SENSORS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENSE_SENSORS_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_CAPSENSE_CONTROL_CHAR_HANDLE   (0x0012u) /* Handle of Control characteristic */
#define CYBLE_CAPSENSE_STATUS_CHAR_HANDLE   (0x0014u) /* Handle of Status characteristic */
#define CYBLE_CAPSENSE_STATUS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0015u) /* Handle of Client Characteristic Configuration descriptor */
