...
const CYBLE_BASS_T cyBle_bass[0x01u] = {
    {
        0x0016u, /* Handle of the BAS service */ 
        0x0018u, /* Handle of the Battery Level characteristic */ 
        0x0019u, /* Handle of the Characteristic Presentation Format descriptor */ 
...
*                                succesfully wrote on the peer device,
...
*                                succesfully read on the peer device,
